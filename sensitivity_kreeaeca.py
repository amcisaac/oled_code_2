...
bounds = [[rates[1]*lb,rates[1]*ub],[rates[2]*lb,rates[2]*ub],[rates[3]*lb,rates[3]*ub]]
...
print("Considering effect of kr, keea, keca only. Bounds: {}k to {}k".format(lb,ub))
...
def obj_2(param_value,rates,jobtyp,fit,x_min,x_max,disr,Vol,shift):
    ...
    all_params[1] = param_value[0]
    all_params[2] = param_value[1]
    all_params[3] = param_value[2]
